...
?>
<section class="mid">
    <form class="log" action="useract2.php" method="POST" onsubmit="return checkPasswordStrength();">
            <label for="new-password">Change your Password:</label>
            <label for="new-password">New Password:</label>
            <input type="password" id="new-password" name="new-password" required><br><br>
            <input type="submit"  name = "adminpasswords"value="Change Password">
        </form>
