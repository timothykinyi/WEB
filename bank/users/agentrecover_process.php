...
if(($username === $username_email) && password_verify($password , $passwrd)) 
{
    ...
    $result = "<img class ='more' src='tmg/sad.png' alt='company logo' height='100px'>Failed wrong auth code  <a href='agentlogin.php'>Try again</a>!  ";
    header("Location: agentlogin.php?error=$result");
