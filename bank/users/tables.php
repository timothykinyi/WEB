...
if ($connection->query($database_table10) === true)
{
            if ($connection->query($database_table) === true)
            {
                if ($connection->query($database_table1) === true)                          
            {
                ...
                echo "Registration successful. <a href='index.php'>Login</a>";
                    ...
                    echo "Error3: " . $database_table2 . "<br>" . $connection_created2->error;
                }
            }
            else {
                echo "Error2: " . $database_table1 . "<br>" . $connection->error;
            }
        }
            else {
                echo "Error2: " . $database_table . "<br>" . $connection->error;
            }

} else {
echo "Error: " . $database_new . "<br>" . $connection->error;
}
